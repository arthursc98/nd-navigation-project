...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done, apply_ddqn = False):
        ...
        if self.t_step == 0:
            ...
            if len(self.memory) > BATCH_SIZE:
                ...
                self.learn(experiences, GAMMA, apply_ddqn)
    ...
    def learn(self, experiences, gamma, apply_ddqn = False):
